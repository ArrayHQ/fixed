 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Fixed
...
add_action( 'tgmpa_register', 'fixed_register_required_plugins' );
 ...
 */
function fixed_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'WPForms Lite',
			'slug'      => 'wpforms-lite',
 ...
 */
add_filter( 'wpforms_shareasale_id', 'fixed_wpforms_shareasale_id' );

function fixed_wpforms_shareasale_id( $shareasale_id ) {
